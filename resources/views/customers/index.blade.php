    ...
    <div class="lg:col-span-2 bg-white rounded shadow overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody>
                @forelse ($customers as $customer)
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-2 text-right whitespace-nowrap">
                            <a href="{{ route('customers.edit', $customer) }}" class="text-blue-600 hover:underline text-xs">Edit</a>
                ...
                @empty
                    <tr><td colspan="4" class="px-4 py-6 text-center text-gray-500">No customers yet.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
